...
//      acc = acc.add(coefficients.mul(ByteVector.fromArray(B256, data, i).rebracket(I256)));
...
//      acc1 = acc1.add(coefficients1.mul(ByteVector.fromArray(B256, data, i).rebracket(I256)));
//      acc2 = acc2.add(coefficients2.mul(ByteVector.fromArray(B256, data, i + B256.length()).rebracket(I256)));
//      acc3 = acc3.add(coefficients3.mul(ByteVector.fromArray(B256, data, i + 2 * B256.length()).rebracket(I256)));
//      acc4 = acc4.add(coefficients4.mul(ByteVector.fromArray(B256, data, i + 3 * B256.length()).rebracket(I256)));
